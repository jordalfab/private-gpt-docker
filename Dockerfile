...
# Install system dependencies: curl and others if needed
...
# Start Ollama in the background, then start the application
ENTRYPOINT ["/bin/bash", "-c", "ollama serve & python -m private_gpt"]
